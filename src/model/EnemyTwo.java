...
public class EnemyTwo extends EnemyShip implements Runnable{
	...
	public EnemyTwo(Canvas canvas, double x, double y) {
		super(canvas);
		this.canvas=canvas;
	...
	@Override
	public void paint() {
		File file =new File("src/image/spaceShips_002.png");
		try {
